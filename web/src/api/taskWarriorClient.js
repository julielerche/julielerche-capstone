...
/**
 * Client to call the TaskWarriorClient.
 *
...
export default class TaskWarriorClient extends BindingClass {
    ...
    constructor(props = {}) {
        ...
        const methodsToBind = ['clientLoaded', 'getIdentity', 'login', 'logout', 'getUser', 'createUser'];
    ...
    async createUser(name, errorCallback) {
        try {
            ...
            const response = await this.axiosClient.post(`users`, {
                name: name,
                id: this.authenticator.getCurrentUserInfo()
            }, {
                headers: {
